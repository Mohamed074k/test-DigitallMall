// src/components/APP_COMPONENTS/PROFILES_COMPONENTS/modelProfileComponents/ModelReelsSection.jsx
import React, { useState } from 'react';
import { Heart, Eye, Calendar, Share2, MessageCircle } from 'lucide-react';

const ModelReelsSection = ({ reels }) => {
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium">{formatNumber(reel.analytics.comments || 0)}</span>
                      </div>
                    </div>
...
export default ModelReelsSection;