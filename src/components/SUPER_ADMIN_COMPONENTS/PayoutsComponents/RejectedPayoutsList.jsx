    ...
    <div className="mt-20 font-[poppins]">
      <div className="mb-6">
        <p className="flex items-center  text-3xl font-semibold mb-4 text-gray-900/50 font-[poppins]">
          <ShieldX size={22} className="text-gray-900/30 mt-1 animate-bounce" />
          <span className="text-gray-900 pl-4">Rejected</span>&nbsp;Payouts
        </p>{" "}
      </div>
      <div className="bg-white rounded-lg shadow overflow-hidden ">
        ...
        {payouts.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">No payouts have been rejected yet.</p>
          </div>
        )}
      </div>
    </div>
...
export default RejectedPayoutsList;
