...
import { FaCheck, FaTimes, FaEllipsisV, FaSearch } from "react-icons/fa";
...
const PendingPayoutsList = ({
  ...
  const filteredPayouts = payouts
    ...
    .filter((payout) => filterType === "All" || payout.type === filterType);
  // .filter((payout) => payout.name.toLowerCase().includes(searchTerm.toLowerCase()));

  return (
    <div className="mt-20 font-[poppins]">
      {/* Title + Filter in one flex row */}
      <div className="mb-6 flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        <p className="flex items-center text-3xl font-semibold text-gray-900/50 font-[poppins]">
          ...
          />
          <span className="text-gray-900 pl-4">Pending</span>&nbsp;Payouts
        </p>
        ...
        <div className="w-full sm:w-56">
          <select
            ...
            className="w-full px-3 py-2 border cursor-pointer border-gray-300 rounded-lg focus:border-transparent"
          >
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden ">
        ...
        <div className="md:hidden divide-y">
          {filteredPayouts.map((payout) => (
            <div key={payout.id} className="p-4 space-y-4 relative">
