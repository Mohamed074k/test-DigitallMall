    ...
    <div className="mt-20 font-[poppins]">
      <div className="mb-6">
        <p className="flex items-center  text-3xl font-semibold mb-4 text-gray-900/50 font-[poppins]">
          ...
          />
          <span className="text-gray-900 pl-4">Paid</span>&nbsp;Payouts
        </p>{" "}
      </div>
        ...
        <div className="md:hidden divide-y">
          {payouts.map((payout) => (
            <div key={payout.id} className="p-4 space-y-4 relative">
              ...
              <div>
                <span className="font-semibold text-gray-600">Paid Date: </span>
                {payout.paidDate || "N/A"}
              </div>
              <div className="mt-3">
                <button
        ...
        {payouts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              No paid payouts found
            </h3>
            <p className="text-gray-500">
              No payouts have been marked as paid yet.
            </p>
          </div>
        )}
      </div>
