...
import AddReelModal from "../../../components/Fashion_Model_Components/reelManagementComponents/addReelModal";
import EditReelModal from "../../../components/Fashion_Model_Components/reelManagementComponents/editReelModal";

const ReelsManagementModel = () => {
  const {
    reels,
    loading,
    error,
  ...
  console.log("currentReels:", currentReels);
    ...
    if (result.isConfirmed) {
      try {
        ...
        if (success) {
          ...
          closeAllActions();
          setExpandedActions((prev) => ({ ...prev, [reelId]: false }));
            ...
            {filteredReels.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  No reels available. Add a new reel to get started.
                </p>
              </div>
            )}
          </div>
...
export default ReelsManagementModel;